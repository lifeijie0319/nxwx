...
//            alert(data);
            $.post('/mana_app/lottery/award/rule2/delete/', data, function(resp){
                if(resp.success){
                    refreshLotteryAward(resp.html);
    ...
    function addLotteryAward(data) {
        $.post('/mana_app/lottery/award/rule2/add/', data, function(resp){
            if(resp.success){
    ...
    function updateLotteryAward(data){
        $.post('/mana_app/lottery/award/rule2/update/', data, function(resp){
            if(resp.success){
                $('#lottery_award_modal').modal('hide');
                refreshLotteryAward(resp.html);
                swal('成功', resp.msg, 'success');
