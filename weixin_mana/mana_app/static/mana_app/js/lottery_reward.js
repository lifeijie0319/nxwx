$(function(){
    ...
    function updateLotteryAward(){
        ...
        $.post('/mana_app/coupon_reward/query/', data, function(resp){
            if(resp.success){
    ...
    function queryLotteryAward(data){
        $.get('/mana_app/coupon_reward/query/', data, function(resp){
            if(resp.success){
    ...
    $('#gen_excel_btn').on('click', function(){
        ...
        window.open('/mana_app/coupon_reward/query/' + query_string);
    });
});
