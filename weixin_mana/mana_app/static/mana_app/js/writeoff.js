$(function(){
    ...
    function updateLotteryAward(){
        ...
        $.post('/mana_app/seller/coupon/off/query/', data, function(resp){
            if(resp.success){
    ...
    function queryLotteryAward(data){
        $.get('/mana_app/seller/coupon/off/query/', data, function(resp){
            if(resp.success){
    ...
    $('#gen_excel_btn').on('click', function(){
        ...
        window.open('/mana_app/seller/coupon/off/query/' + query_string);
    });
});
