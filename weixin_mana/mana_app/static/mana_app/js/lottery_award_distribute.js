$(function(){
    ...
    function updateLotteryAward(){
        ...
        $.post('/mana_app/lottery/award/distribute/', data, function(resp){
            if(resp.success){
    ...
    function queryLotteryAward(data){
        $.get('/mana_app/lottery/award/distribute/query/', data, function(resp){
            if(resp.success){
    ...
    $('#gen_excel_btn').on('click', function(){
        ...
        window.open('/mana_app/lottery/award/distribute/query/' + query_string);
    });
});
